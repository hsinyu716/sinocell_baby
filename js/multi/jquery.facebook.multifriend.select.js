...
(function($) { 
    var JFMFS = function(element, options) {
        ...
        elem.html(
            ...
            "        <span class='jfmfs-title'>" + settings.labels.filter_title + " </span><input type='text' id='jfmfs-friend-filter-text' placeholder='" + settings.labels.filter_default + "'/>" +
        ...
        var init = function() {
            ...
            elem.delegate(".jfmfs-friend", 'click', function(event) {
                var onlyOne = settings.max_selected === 1,
                    ...
                    // hsinyu 猜拳機 選擇後加入姓名
                    $('#selected_f').html($(this).children(".friend-name").html());
